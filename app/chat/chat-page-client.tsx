...
import { Menu, LogOut, UserIcon, BookOpen, Sun, Moon, Palette } from "lucide-react"
...
export default function ChatPageClient() {
  ...
  if (authLoading || configLoading) {
    return (
      <div className={cn("flex items-center justify-center min-h-screen", currentTheme.bg)}>
        <Loader2 className="h-10 w-10 animate-spin" style={{ color: currentTheme.primary }} />
      </div>
    )
  }
      ...
      <div className={cn("flex h-screen", currentTheme.bg)}>
        ...
        <div className="hidden lg:block">
          <ChatSidebar
            ...
            user={user}
            appConfig={{ appName, logo: logo || prophetAvatar, prophetName, prophetAvatar }}
            onClose={() => {}}
          ...
          <header className={cn("flex items-center justify-between p-4 border-b", currentTheme.header, currentTheme.border)}>
            <div className="flex items-center gap-3">
              <Button
                ...
                className={cn("h-9 w-9 lg:!hidden", currentTheme.button)}
                title="Abrir menu"
              >
            ...
            <div className="flex items-center gap-2">
              ...
              <Button
                ...
                className={cn("gap-2", currentTheme.button, currentTheme.border)}
              >
                <BookOpen className={cn("h-4 w-4", currentTheme.muted)} />
                <span className={cn("hidden sm:inline", currentTheme.text)}>Estudos Bíblicos</span>
              </Button>
                      ...
                      {Object.entries(themeStyles).map(([key, style]) => (
                        <button
                          ...
                          style={{ 
                            ...
                            borderColor: theme === key ? style.previewAccent : undefined,
                            boxShadow: theme === key ? `0 0 0 2px ${style.previewAccent}, 0 0 0 4px ${style.previewBg}` : undefined
                          }}
                        >
